...
if ($sql == true) {
    ...
    $form = '<form action="" method="POST">
                    ...
                    <div>
                        <label for="formative">formative_assessment50</label>
                        <input type="text" name="formative_assessment/50" value="' . $fetch['formative_assessment/50'] . '" >
                    </div>
                    <div>
                    <label for="summative">summative_assessment/50</label>
                    <input type="text" name="summative_assessment/50" value="' . $fetch['summative_assessment/50'] . '" >
                </div>
